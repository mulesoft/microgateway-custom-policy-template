export PDK_COMPATIBILITY_VERSION = 1.5.0-rc.2
...
install-cargo-anypoint:
	cargo install cargo-anypoint@{{ cargo_anypoint_version | default: "1.5.0-rc.2" }} --registry anypoint --config .cargo/config.toml
